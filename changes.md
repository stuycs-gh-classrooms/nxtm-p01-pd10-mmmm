Changes we've made:
- We do in fact need a 1D array for our bullets. We are still figuring out how to implement, may need to use code from ListArray since we need to append new bullets everytime space is pressed.
